...
export const ERROR_CODES = Object.freeze({
  ...
  V_MISSING_COMPONENTS: 'V_MISSING_COMPONENTS',
  V_INVALID_COMPONENT_COUNT: 'V_INVALID_COMPONENT_COUNT',
  V_DUPLICATE_ROLE: 'V_DUPLICATE_ROLE',
  V_DUPLICATE_COMPONENT: 'V_DUPLICATE_COMPONENT',
  V_INVALID_ROLE: 'V_INVALID_ROLE',
  V_INVALID_LOOP_BARS: 'V_INVALID_LOOP_BARS',
  V_MISSING_EXPECTED: 'V_MISSING_EXPECTED',
  V_INVALID_SHIFT: 'V_INVALID_SHIFT',
  V_MISSING_CRATE_ITEM: 'V_MISSING_CRATE_ITEM',
  V_INVALID_DESTINATION_BARS: 'V_INVALID_DESTINATION_BARS',
  S_STALE_CRATE: 'S_STALE_CRATE',
  S_STACK_PREPARE_FAILED: 'S_STACK_PREPARE_FAILED',
  S_STEM_UNAVAILABLE: 'S_STEM_UNAVAILABLE',
  S_ASSET_NOT_AVAILABLE: 'S_ASSET_NOT_AVAILABLE',
  S_ASSET_MISMATCH: 'S_ASSET_MISMATCH',
...
const MESSAGES = Object.freeze({
  ...
  V_MISSING_COMPONENTS: 'preview_stem_stack payload.components is required',
  V_INVALID_COMPONENT_COUNT: 'preview_stem_stack requires 1 to 4 components',
  V_DUPLICATE_ROLE: 'each stack role may appear at most once',
  V_DUPLICATE_COMPONENT: 'each crate item may appear at most once',
  V_INVALID_ROLE: 'stack role must be beat, bass, other, or voice',
  V_INVALID_LOOP_BARS: 'loopBars must be 1, 2, 4, or 8',
  V_MISSING_EXPECTED: 'each component.expected identity is required',
  V_INVALID_SHIFT: 'tempoRatio/semitoneShift is missing or out of bounds',
  V_MISSING_CRATE_ITEM: 'component.crateItemId is required',
  V_INVALID_DESTINATION_BARS: 'destinationBars must be 1, 2, 4, or 8',
  S_STALE_CRATE: 'crate source, grid, or loop identity is stale',
  S_STACK_PREPARE_FAILED: 'the stem stack could not be prepared',
  S_STEM_UNAVAILABLE: 'referenced crate stem media is unavailable',
  S_ASSET_NOT_AVAILABLE: 'no prepared asset is available to accept',
  S_ASSET_MISMATCH: 'accepted asset does not match the prepared file',
...
export function messageFor(code) {
  return MESSAGES[code] || MESSAGES[ERROR_CODES.X_INTERNAL];
}
